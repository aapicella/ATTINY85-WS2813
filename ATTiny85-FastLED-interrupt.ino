 ...
 * Datasheet for ATTINY85 is here:
...
void setup() {
     ...
     * the PCMSK0 Register
     */
    GIMSK = 0b00100000;    // bit 5 turns on pin change interrupts 
    /* 
     *   PCMSK – Pin Change Mask Register
     *   are from right to left pin 0,1,2,3...
     *   Each bit selects whether pin change interrupt is enabled on the corresponding I/O pin. If PCINT[5:0] is
